...
class UserSession:
    ...
    def _launch_new_request(self, timestamp: float,
        ...
        prompt += "Can you tell me a detailed story in AT LEAST 2500 words? Repeat the story 20 times."
        logger.info(prompt)
...
class UserSessionManager:
    ...
    def step(self, timestamp: float, executor: RequestExecutor):
        ...
        if timestamp - self.initial_time >= mooncake_data[self.mooncake_request_to_send]["timestamp"] / 1000:
